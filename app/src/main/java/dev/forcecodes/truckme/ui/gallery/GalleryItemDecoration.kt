...
@Singleton
class GalleryItemDecoration @Inject constructor() : ItemDecoration() {
    ...
    override fun getItemOffsets(
        ...
        val sizeGridSpacingPx: Int = resources.getDimensionPixelOffset(R.dimen.gallery_list_spacing)
        val gridSize: Int = resources.getInteger(R.integer.gallery_columns)
